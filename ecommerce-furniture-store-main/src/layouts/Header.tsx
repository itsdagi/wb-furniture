  ...
  return (
    ...
    <div className='main__container h-[100px] flex flex-row justify-between items-center pl-[10px] pr-[10px] py-[30px] mm:pl-[54px] mm:pr-[54px]'>
        <div className='flex flex-row justify-center items-center cursor-pointer' onClick={goToMain}>
            ...
            <h1 className='hidden text-[18px] mont font-[700] ml-[5px] sml:flex s:text-[28px]'>WB Furniture</h1>
        </div>
        <div className='flex flex-row justify-between items-center w-[220px] h-[30px] mm:w-[280px]'>
            <Link className='mont font-[500] text-[14px] mm:text-[16px] hover:underline duration-300' href="/">Home</Link>
            <Link className='mont font-[500] text-[14px] mm:text-[16px] hover:underline duration-300' href="/shop">Product</Link>
            <Link className='mont font-[500] text-[14px] mm:text-[16px] hover:underline duration-300' href="/about">Contact</Link>
        </div>
