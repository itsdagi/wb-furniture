...
const InfoAboutProduct = () => {
    ...
    return (
        <div className="flex flex-col w-[350px] extrasml:w-[450px] h-[500px] mt-[40px] ipad:mt-[0px] border-b-[#D9D9D9] border-b-[1px]">
            ...
            <h2 className="mont text-[#9F9F9F] text-[24px] font-[500]">{allProducts[params - 1].price} Birr</h2>
            ...
            <div className='flex flex-row mt-[32px]'>
                ...
                <div onClick={addToCart} className='active:bg-[#898989] duration-200 flex flex-row justify-center items-center w-[123px] h-[64px] border border-[#000] rounded-[10px] ml-[18px]'>
                    <p className='mont text-[16px] font-[400] text-black hover:underline cursor-pointer'>Add to cart</p>
                </div>
            </div>
        </div>
    )
