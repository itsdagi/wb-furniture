...
const OurProducts = () => {
  return (
    <div className="w-full flex flex-col justify-start items-center mt-[40px] px-[10px] lg:px-[65px]">
        <h1 className="text-[40px] font-[700] text-[#3A3A3A] mb-[32px]">Products</h1>
        ...
        <button className="mt-[32px] w-[245px] h-[48px] border border-[#B88E2F] bg-white hover:bg-[#B88E2F] duration-300"><p className="text-[16px] text-[#B88E2F] font-[600] hover:text-white duration-300">Load More</p></button>
    </div>
  )
}
